...
iptables -A FORWARD -i ${WG_DEFAULT_INTERFACE} -j ACCEPT;
iptables -A FORWARD -o ${WG_DEFAULT_INTERFACE} -j ACCEPT;
`.split('\n').join(' ');
...
iptables -D FORWARD -i ${WG_DEFAULT_INTERFACE} -j ACCEPT;
iptables -D FORWARD -o ${WG_DEFAULT_INTERFACE} -j ACCEPT;
`.split('\n').join(' ');
